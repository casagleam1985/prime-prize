...
const clerkAppearance = {
  ...
  elements: {
    ...
    formFieldInput: "border-border bg-white text-foreground",
    ...
    <ClerkProvider
      ...
      localization={{
        signIn: {
          start: {
            title: "Welcome back",
            subtitle: "Sign in to your Prime Prize account",
          },
        },
        signUp: {
          start: {
            title: "Create your account",
            subtitle: "Join Prime Prize and start winning today",
          },
        },
      }}
